select rental_id, rental.inventory_id , staff_id , rental.last_update as rental_last_update , rental_date, title, first_name , email , active , rental.customer_id , return_date 
